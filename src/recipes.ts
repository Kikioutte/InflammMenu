...
import { IMPORTED_PLAN_RECIPES } from "./planner-catalog.ts";
...
function ingredient(id: IngredientId, quantity: number, unit: IngredientUnit): Ingredient {
  ...
  return {
    ...
    ...(shoppingRuleFor(id)?.pantry_staple === true ? { pantryStaple: true } : {}),
  };
}
...
const BASE_RECIPE_SOURCE: readonly Recipe[] = [
  {
    ...
    mealTypes: ["breakfast"], diet: VEGETARIAN, prepMinutes: 8, restMinutes: 480, costPerPortion: 1.7,
    ...
    conservation: "24 heures au réfrigérateur dans un récipient fermé.", image: "/assets/recipes/overnight-oats-myrtilles-noix.jpg",
  },
  {
    ...
    conservation: "À assembler juste avant dégustation.", image: "/assets/recipes/yaourt-pomme-amandes.jpg",
  },
  {
  ...
  },
  {
    ...
    mealTypes: ["breakfast"], diet: VEGETARIAN, prepMinutes: 7, restMinutes: 180, costPerPortion: 1.55,
    ...
    conservation: "Jusqu’à 2 jours au réfrigérateur.", image: "/assets/recipes/pudding-chia-poire-cacao.jpg",
  },
  {
...
export { DEFAULT_PROFILE } from "./domain.ts";
