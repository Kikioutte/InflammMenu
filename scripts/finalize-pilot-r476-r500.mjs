...
const extraCautions = {
  ...
  r478: "Conserver le yaourt au froid jusqu'au service.",
  r479: "Cuire le centre à cœur puis refroidir rapidement avant réfrigération.",
  r480: "Maintenir la chaîne du froid et ne jamais recongeler un granité décongelé.",
  r481: "Conserver le yaourt au froid et laisser la vapeur s'échapper au mixage.",
  ...
  r487: "Laisser la vapeur s'échapper avant tout mixage chaud.",
  r488: "Le sodium dépend fortement des olives; les rincer et vérifier l'étiquette.",
  r489: "Refroidir la betterave avant ajout du yaourt et maintenir la sauce au froid.",
  r490: "Refroidir le brocoli avant l'ajout des herbes et réfrigérer rapidement.",
  r491: "Ajuster le vinaigre selon l'acidité du fruit et conserver au froid.",
  r492: "Réaliser le trempage au réfrigérateur et maintenir la préparation au froid.",
  ...
  r495: "Préparation crue à maintenir au froid et à consommer sous 24 heures.",
  r496: "Le sodium du miso dépend du produit, vérifier l'étiquette et ne pas ajouter de sel avant dégustation.",
  r497: "Le vinaigre peut contenir des sulfites selon le produit; vérifier l'étiquette et maintenir la vinaigrette au froid.",
  r498: "Le sodium des câpres dépend du produit, les rincer et vérifier l'étiquette.",
  r499: "Ajouter le raifort progressivement, refroidir avant le yaourt et conserver au froid.",
