...
test("collection, orange pairs, scaled portions and complete meal", async ({ page }, info) => {
  ...
  await expect(builder.getByTestId("meal-builder-slot-main")).toContainText("Cabillaud en papillote de chou et fenouil");
  ...
  await expect(builder.getByTestId("meal-builder-slot-dessert")).toContainText("Crème glacée minute d'avocat et banane");
  ...
  await expect(builder.getByTestId("meal-builder-status")).toContainText("Repas complet compatible");
  await expect(builder.getByTestId("meal-builder-status")).toContainText("orange");
